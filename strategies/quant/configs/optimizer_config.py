...
PARAMETER_BOUNDS = {
    ...
    "alpha_smooth_span": {"type": "int", "low": 10, "high": 100},

    "regime_sensitivity": {"type": "float", "low": 0.5, "high": 1.0},

    "hurst_window": {"type": "int", "low": 50, "high": 200},
    "max_lag": {"type": "int", "low": 10, "high": 20}
}